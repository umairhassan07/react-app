           ...
           <div class="services_section_2">
              <div class="row">
                 <div class="col-lg-4 col-sm-12 col-md-4">
                    <div class="box_main active">
                       <div class="house_icon">
                          <img src="assets/images/icon1.png" class="image_1"></img>
                          <img src="assets/images/icon1.png" class="image_2"></img>
                       </div>
                 ...
                 <div class="col-lg-4 col-sm-12 col-md-4">
                    <div class="box_main">
                       <div class="house_icon">
                          <img src="assets/images/icon2.png" class="image_1"></img>
                          <img src="assets/images/icon2.png" class="image_2"></img>
                       </div>
                 ...
                 <div class="col-lg-4 col-sm-12 col-md-4">
                    <div class="box_main">
                       <div class="house_icon">
                          <img src="assets/images/icon3.png" class="image_1"></img>
                          <img src="assets/images/icon3.png" class="image_2"></img>
                       </div>
